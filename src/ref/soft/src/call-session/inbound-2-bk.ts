...
// //     public async answer() {
// //         console.log("InboundCallSession] Answering incoming call");
// //         const answerSDP = `
// // v=0
// // o=- ${randomInt()} 0 IN IP4 127.0.0.1
// // s=rc-softphone-ts
...
// //         await this.startLocalServices();
// //         console.log("[InboundCallSession] Incoming call answered");
// //     }

// //     protected async startLocalServices(): Promise<void> {
// //         console.log("InboundCallSession] Starting local services");
// //         this.socket = dgram.createSocket("udp4");

// //         this.socket.on("message", (message) => {
// //             console.log(`[InboundCallSession] Receiving message: ${message}`);
// //             const rtpPacket = RtpPacket.deSerialize(message);
// //             this.packetsReceived++;
// //             this.bytesReceived += message.length;
...
// //             if (rtpPacket.header.payloadType === 0) {
// //                 // PCMU
// //                 console.log(`[InboundCallSession] Emitting PCMU Packet`);
// //                 this.emit("audioPacket", rtpPacket.payload);
// //             } else if (rtpPacket.header.payloadType === 101) {
// //                 // DTMF
// //                 console.log(`[InboundCallSession] Emitting DTMF Packet`);
// //                 this.emit("dtmfPacket", rtpPacket);
// //             }
// //         });

// //         return new Promise<void>((resolve) => {
// //             console.log("[InboundCallSession] Initializing UDP socket");
// //             if (!this.socket) {
// //                 throw new Error(
// //                     "[InboundCallSession] UDP socket is not initialized"
// //                 );
// //             }
// //             this.socket.bind(() => {
// //                 console.log(
