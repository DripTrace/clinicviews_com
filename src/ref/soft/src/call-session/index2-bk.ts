...
// // // // // //     protected sipMessage: InboundMessage;
...
// // // // // //     public get callId() {
// // // // // //         console.log(`[CallSession] Retrieving callId`);
// // // // // //         return this.sipMessage.headers["Call-Id"];
// // // // // //     }
...
// // // // // //     public send(data: Buffer) {
// // // // // //         console.log(`[CallSession] sending data: ${data}`);
// // // // // //         if (this.isActive && this.socket) {
// // // // // //             console.log(`[CallSession] there is an active socket`);
// // // // // //             this.socket.send(data, this.remotePort, this.remoteIP, (error) => {
// // // // // //                 if (error) {
// // // // // //                     console.error(
...
// // // // // //                     );
// // // // // //                 } else {
// // // // // //                     console.log(`[CallSession] packets are being sent`);
// // // // // //                     this.packetsSent++;
// // // // // //                     this.bytesSent += data.length;
// // // // // //                 }
// // // // // //             });
...
// // // // // //         console.log(`[CallSession] Sending audio: ${audioData}`);
// // // // // //         const rtpPacket = this.createRtpPacket(audioData);
// // // // // //         this.send(rtpPacket.serialize());
// // // // // //     }

// // // // // //     protected createRtpPacket(audioData: Buffer): RtpPacket {
// // // // // //         console.log(`[CallSession] Creating RTP packet: ${audioData}`);
// // // // // //         const rtpHeader = new RtpHeader({
// // // // // //             version: 2,
// // // // // //             padding: false,
// // // // // //             extension: false,
...
// // // // // //     public async init() {
// // // // // //         console.log("[CallSession] Initiating call session");
// // // // // //         this.isActive = true;
// // // // // //         await this.startLocalServices();
// // // // // //     }
...
// // // //         // Emit audio data event for external logging or further processing
// // // //         this.emit("audioDataSent", audioData);
// // // //     }
...
// // // //         if (this.isActive) {
// // // //             console.log(
// // // //                 `[CallSession] Hanging up call with ID: ${this.callId}`
// // // //             );
// // // //             await this.softphone.hangup();
// // // //             this.dispose();
// // // //         }
...
// // // //     public endSession() {
// // // //         console.log(`[CallSession] Ending session for call ID: ${this.callId}`);
// // // //         this.dispose();
// // // //     }

// // // //     public dispose() {
// // // //         console.log(
// // // //             `[CallSession] Disposing session for call ID: ${this.callId}`
// // // //         );
// // // //         this.isActive = false;
// // // //         if (this.socket) {
// // // //             this.socket.removeAllListeners();
...
// // // //         console.log(
// // // //             `[CallSession] New session created for Call ID: ${this.callId}`
// // // //         );
// // // //     }
...
// // // //             console.log("[CallSession] WebSocket opened")
// // // //         );
// // // //         this.webSocket.on("message", (message) =>
// // // //             console.log(`[CallSession] WebSocket message received: ${message}`)
// // // //         );
// // // //         this.webSocket.on("close", () =>
// // // //             console.log("[CallSession] WebSocket closed")
// // // //         );
// // // //         this.webSocket.on("error", (error) =>
// // // //             console.error(`[CallSession] WebSocket error: ${error}`)
// // // //         );
// // // //     }

// // // //     public send(data: Buffer) {
// // // //         console.log(
// // // //             `[CallSession] Attempting to send data of size: ${data.length}`
// // // //         );
...
// // // //                 if (error) {
// // // //                     console.error(
// // // //                         `[CallSession] Error sending RTP packet:`,
// // // //                         error
// // // //                     );
// // // //                 } else {
// // // //                     console.log(
// // // //                         `[CallSession] RTP packet sent successfully, packet size: ${data.length}`
// // // //                     );
// // // //                     this.packetsSent++;
// // // //                     this.bytesSent += data.length;
// // // //                 }
...
// // // //         } else {
// // // //             console.warn(
// // // //                 `[CallSession] Attempted to send data without an active socket`
// // // //             );
// // // //         }
// // // //     }
...
// // // //     public async sendAudio(audioData: Buffer): Promise<void> {
// // // //         console.log(
// // // //             `[CallSession] Sending audio data, size: ${audioData.length}`
// // // //         );
