...
// //         // Check if the request contains the "code" and "state" parameters, indicating a redirect from RingCentral
// //         if (code && state) {
// //             try {
...
// //                     code_verifier: storedCodeVerifier, // Add the code_verifier here
// //                 });
...
// //                 // Save the token data in the session, local storage, or pass it directly as a query parameter
// //                 // Then redirect to the sip page
// //                 res.redirect(
// //                     302,
...
// //             }
// //         } else {
// //             // If no code and state, proceed with normal auth flow
// //             try {
...
// //                 loginUrl.searchParams.append("state", codeVerifier); // Storing codeVerifier in the state
...
// //                 code,
// //                 redirect_uri: process.env.NEXT_PUBLIC_RC_REDIRECT_URI!,
// //                 code_verifier: state, // Ensure the code_verifier is being sent correctly
// //             });
...
//         // Handle the redirect after RingCentral authentication
//         if (code && state) {
//             try {
//                 const storedCodeVerifier = state as string;
