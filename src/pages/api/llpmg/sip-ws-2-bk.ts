...
//                         console.error("[SIP-WS] Softphone not initialized");
//                         socket.emit("error", {
//                             message: "[SIP-WS] Softphone not initialized",
//                         });
//                     }
//                 } catch (error) {
//                     console.error("[SIP-WS] Error starting call:", error);
...
//                 if (softphone && softphone.currentCallSession) {
//                     console.log(
//                         `[SIP-WS] Received audio data from client, size: ${audioData.byteLength} bytes`
//                     );
//                     softphone.sendAudio(audioData);
//                 }
//             });
...
//                         softphone!.on("callStarted", (callId: string) => {
//                             console.log(
//                                 `[SIP-WS] Call started with ID: ${callId}`
//                             );
