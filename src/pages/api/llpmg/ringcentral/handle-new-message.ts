...
//         const rcNumber = process.env.RC_PHONE_NUMBER;
//         if (!rcNumber) {
//             throw new Error("RC_PHONE_NUMBER is not set");
//         }

//         if (toNumber === formatPhoneNumber(rcNumber)) {
//             const forwardTo = "+19092130299"; // Replace with actual number
//             console.log(
