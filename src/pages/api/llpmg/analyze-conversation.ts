// // src/pages/api/llpmg/analyze-conversation.ts
...
//     try {
//         // Build the AI prompt with the current conversation context
//         const prompt = `
...
//         Conversation so far:
//         ${conversation}
//         Provide a brief, clear suggestion for the next step.
//         `;
...
//             // Safely handle the case where the content is null or undefined
//             return res
//                 .status(500)
