...
//         if (!patientName || !email || !phone || !reason) {
...
//             return res
//                 .status(400)
//                 .json({ error: "Missing required fields in form data" });
//         }
...
//             EmailTemplate({
//                 name: patientData.displayName,
//                 email: patientData.emailAddresses[0].address,
...
//                     ? appointmentDate[0]
//                     : appointmentDate,
//                 appointmentTime: Array.isArray(appointmentTime)
//                     ? appointmentTime[0]
//                     : appointmentTime,
//             })
//         );
...
//             throw new Error(
//                 "Missing required fields: patientName or email is not provided"
//             );
//         }
    ...
    try {
        ...
        if (
            ...
            return res
                ...
                .json({
                    message:
                        "Patient registered successfully without appointment.",
                });
        }
