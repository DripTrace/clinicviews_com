...
const WhyChooseUs: React.FC = () => {
	return (
		<motion.div
			...
			className="container mt-[4rem] mx-auto px-4 py-8 bg-blue-50 dark:bg-gray-700 rounded-md"
		>
			<h2 className="text-3xl font-bold dark:text-blue-100 text-blue-900 mb-4">
				Why Choose LLPMG?
			</h2>
			<section className="mb-8">
				<h3 className="text-xl font-semibold mb-2 dark:text-blue-100 text-blue-900 ">
					Mission and Vision
				</h3>
				<p className="mb-4 dark:text-blue-300 text-blue-700 ">
			...
			<section>
				...
				<ul className="list-disc pl-5 mb-4 dark:text-blue-300 text-blue-700">
