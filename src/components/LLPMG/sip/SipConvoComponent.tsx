...
//                 audio: "processing_01.ogg",
//             },
//             {
//                 text: "Certainly, I'm working on that now.",
//                 audio: "processing_02.ogg",
//             },
//             {
//                 text: "Thank you for your patience. I'm retrieving that information.",
//                 audio: "processing_03.ogg",
//             },
//             {
//                 text: "I appreciate your request. Please give me a moment.",
//                 audio: "processing_04.ogg",
//             },
//             {
//                 text: "I'm on it. This will just take a second.",
//                 audio: "processing_05.ogg",
//             },
//             {
//                 text: "Of course, I'm looking into that right away.",
//                 audio: "processing_06.ogg",
//             },
//             {
//                 text: "I hear you. Let me get that information for you.",
//                 audio: "processing_07.ogg",
//             },
//             {
//                 text: "Absolutely, I'm processing your request now.",
//                 audio: "processing_08.ogg",
//             },
//             {
//                 text: "Thank you for asking. I'm working on finding the answer.",
//                 audio: "processing_09.ogg",
//             },
//             {
//                 text: "I'm here to help. Please allow me a moment to assist you.",
//                 audio: "processing_10.ogg",
//             },
//             {
//                 text: "I'm checking on that for you now.",
//                 audio: "processing_11.ogg",
//             },
//             {
//                 text: "Your request is important. I'm working on it as we speak.",
//                 audio: "processing_12.ogg",
//             },
//             {
//                 text: "I'm accessing that information now. It won't take long.",
//                 audio: "processing_13.ogg",
//             },
//             {
//                 text: "Certainly, I'm retrieving those details for you.",
//                 audio: "processing_14.ogg",
//             },
//             {
//                 text: "I understand your need. I'm processing that request right away.",
//                 audio: "processing_15.ogg",
//             },
//         ],
//     };
...
//     const playProcessingPhrase = useCallback(() => {
//         if (processingAudioRef.current) {
//             const randomPhrase =
//                 processingPhrases.processingPhrases[
//                     Math.floor(
//                         Math.random() *
//                             processingPhrases.processingPhrases.length
//                     )
//                 ];
//             processingAudioRef.current.src = `/llpmg/audio/processing/${randomPhrase.audio}`;
//             processingAudioRef.current.play();
//         }
//     }, []);
...
//             const { audioUrl, suggestionText } = await generatedResponse.json();
...
//         // if (isTranscribingRef.current) return;
//         // isTranscribingRef.current = true;
//         if (isTranscribingRef.current || isProcessing) return;
//         isTranscribingRef.current = true;
//         if (!combinedStreamRef.current) {
//             isTranscribingRef.current = false;
//             return;
...
//         const filterTranscription = (text: string): string => {
//             const wordsToFilter = ["thank you", "bye-bye", "bye", "thanks"];
//             return text
//                 .split(" ")
...
//                     dispatch(addSystemMessage("System: " + text));
//                     setTranscribedText("System: " + text);
...
//             session.on("terminated", () => handleCallTerminated(session));
//         },
//         [dispatch, generateGreeting, startRecording]
//     );
...
//                 <audio id="remoteAudio" ref={remoteAudioRef} hidden />
//                 <audio id="localAudio" hidden muted />
//                 <audio ref={processingAudioRef} hidden />
//                 {isProcessing && (
