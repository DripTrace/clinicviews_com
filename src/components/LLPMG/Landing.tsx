...
const Landing: React.FC = () => {
	...
	return (
		<div className="min-h-screen bg-blue-50 dark:bg-gray-900 transition-colors duration-300 relative">
			<motion.section
			...
			<main className="container mx-auto px-4 py-8 gap-[5rem] space-y-[8rem]">
