...
const ConditionsTreated: React.FC = () => {
    return (
        ...
        >
            <div className="absolute w-full 2xl:w-full 2xl:h-full z-10 top-[0rem] lg:top-[-4rem] xl:top-[-15.2rem] 2xl:top-[0rem]">
                <Image
                    src="/conditions.svg"
                    alt="llpmg-hero-img"
                    height={50}
                    width={150}
                    className="size-full 2xl:object-cover z-10 rounded-lg"
                />
            </div>
