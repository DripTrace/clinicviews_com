...
const ConditionsTreated: React.FC = () => {
	return (
		<motion.section
			...
			className="py-16 bg-blue-900 dark:bg-gray-800 text-white relative transition-colors duration-300 rounded-xl z-20 2xl:mb-[40rem]"
		>
			...
			<div className="container mx-auto px-4 relative z-40">
				...
				<h2 className="text-blue-600 relative text-3xl font-bold mb-8 text-center z-40">
					Conditions We Treat
				</h2>
